...
class Tmj_Post_Notice_Editor {
  ...
  public function post_notice_display() {
    require_once( plugin_dir_path(__FILE__) . 'views/tmj-post-notice-editor.php' );
  }
  ...
  public function save_post_notice( $post_id ) {
    ...
    $post_notice = $_POST['tmj-post-notice-editor'];
    $post_notice = stripslashes( strip_tags( $post_notice) );
    update_post_meta( $post_id, 'tmj-post-notice', $post_notice );
  }
